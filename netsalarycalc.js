...
/*
Gross salary = 100000
nssf = (100000 * 0.06) = 6000
nhif = 2400 //(2400 * 0.15) = 360 * 

100000- (nssf + nhif)
let taxableIncome = 100000 - (nssf + nhif) //93640
let payee = tax(taxableIncome).paye
let net salary = tax(taxableIncome).netsalary

NSSFDeductions = 6000
NHIFDeduction s = 2400
payee (i.e. Tax) = 15873 // tax.paye
gross salary = 100000
net salary = 62427 // tax.netsalary
*/
...
console.log(kratax(100000, 20000))
